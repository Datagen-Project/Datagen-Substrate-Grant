...
Now you could visualize the event in the network inspector, note at the moment we have also an empty peerId value, this is correct we add this information for maybe future implementation but we will use the owner account to do the check at the moment.
