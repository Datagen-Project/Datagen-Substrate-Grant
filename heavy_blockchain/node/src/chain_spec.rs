...
use rialto_parachain_runtime::{
    AccountId, AuraId, BridgeMillauMessagesConfig, RandomNodeSelectorConfig, Signature,
    XcmMillauBridgeHubConfig,
};
...
fn testnet_genesis(
    ...
    rialto_parachain_runtime::RuntimeGenesisConfig {
        ...
        sudo: rialto_parachain_runtime::SudoConfig {
            key: Some(root_key),
        },
